...
void test_results() {
    ...
    for (i = 0; i < sizeof(cases) / sizeof(test_case); ++i) {
         char *expr = cases[i].expr;
         double answer = cases[i].answer;

        int err;
         double ev = te_interp(expr, &err);
        lok(!err);
        lfequal(ev, answer);
...
void test_syntax() {
    ...
    for (i = 0; i < sizeof(errors) / sizeof(test_case); ++i) {
         char *expr = errors[i].expr;
         int e = errors[i].answer;
...
void test_nans() {
    ...
    int i;
    for (i = 0; i < sizeof(nans) / sizeof( char *); ++i) {
         char *expr = nans[i];
...
void test_infs() {
    ...
    int i;
    for (i = 0; i < sizeof(infs) / sizeof( char *); ++i) {
         char *expr = infs[i];
...
void test_closure() {
    ...
    for (i = 0; i < sizeof(cases2) / sizeof(test_case); ++i) {
         char *expr = cases2[i].expr;
         double answer = cases2[i].answer;
...
void test_pow() {
    ...
    for (i = 0; i < sizeof(cases) / sizeof(test_equ); ++i) {
         char *expr1 = cases[i].expr1;
         char *expr2 = cases[i].expr2;
