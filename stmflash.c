...
void SysRead()
{
		...
		STMFLASH_Read(0x8000000+30*1024,(u16 *)&sys[0],20);//读取数据
...
void SysSave()
{
		...
		STMFLASH_Write(0x8000000+30*1024,(u16 *)&sys[0],20);//读取数据
